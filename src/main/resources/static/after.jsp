...
<script>
	 ...
	 window.onload=function(){
                ...
                // var examlink= params.get('quiz');	
//console.log(examlink);
document.getElementById("am").innerHTML = name;  
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9 col-md-9">
					<a  class="site-btn header-btn" id="am">Sign/Sign Up</a>
					<nav class="main-menu">
						<ul>
		...
		<div class="container">
			...
			<div class="row">
                <div class="column" style="background-color:white;">
					 ...
					 <a href="#" id="exam"><b>String mock test</b></a>
					 <%
...
{
%>
<a  style="color:red;font-size: 20px" href<%=qo.get(i).getLink()%> ><b><%=qo.get(i).getName()%></b></a>
<%} %>
                </div>
          <div class="column" style="background-color:white;">
                   <h2 style="color:#dc3545">Latest Jobs</h2>
                  
				  <marquee>Latest String quiz</marquee>
          </div>
          </div>
		</div>
	</section>
